...
<template>
  <div class="fixed w-full h-screen bg-black">
    ...
    <div v-if="!showFullVideo" id="SideNav" class="flex z-40 items-center w-[120px] h-screen bg-black relative">
      <h1 class="gradient-text-green text-6xl font-bold absolute top-6 left-6 hover110">VF</h1>
      <div>
        <div class="py-2 mx-10 my-6 hover125">
          <Magnify fillColor="#bbbb" :size="40" />
        </div>
        <div class="py-2 mx-10 my-6 border-b-4 border-b-red-500 hover125">
          <HomeOutline fillColor="#FFFFFF" :size="40" />
        </div>
        <div class="py-2 mx-10 my-6 hover125">
          <TrendingUp fillColor="#bbbb" :size="40" />
        </div>
        <div class="py-2 mx-10 my-6 hover125">
          <Television fillColor="#bbbb" :size="40" />
        </div>
        <div class="py-2 mx-10 my-6 hover125">
          <MovieOutline fillColor="#bbbb" :size="40" />
        </div>
        <div class="py-2 mx-10 my-6 hover125">
          <Plus fillColor="#bbbb" :size="40" />
        </div>
      </div>
    </div>
