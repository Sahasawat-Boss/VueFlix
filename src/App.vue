  ...
  <div class="w-full h-screen bg-black overflow-hidden">
    ...
    <div v-if="!showFullVideo">
      ...
      <div class="relative w-full h-[50vh] bg-black overflow-hidden">
        ...
        <MovieDetails v-if="movie" :movie="movie" class="absolute z-50" />
      ...
      <div class="relative w-full h-[50vh] overflow-y-auto px-4 md:px-6">
        <VideoCarousel class="pb-8" category="Popular Movies" :movies="movies[0]" />
        <VideoCarousel class="pb-8" category="Horror Movies" :movies="movies[1]" />
