<template>
    <footer
        class="w-full bg-black text-white pt-8 pb-16 px-4 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4 fade-in">
        <!-- Left: Links -->
        ...
        <!-- Right: Copyright -->
        <div class="text-sm text-gray-400 text-center md:text-right tracking-wider">
